...
class Errors {
    ...
    public static readonly SCHEDULED_IN_PAST: string = 'Cannot schedule a job to complete in a time that is the past.'
    public static readonly INVALID_JOB_KEY: string = 'Invalid Key provided.'
    public static readonly INVALID_JOB_TYPE: string = 'The job type must be a valid string and with a length greater than 0.'
